...
INSERT INTO `pedido_caracteristicas` VALUES (60,1,1),(49,1,2),(50,1,2),(54,1,2),(55,1,2),(56,1,2),(58,1,2),(59,1,2),(62,1,2),(63,1,2),(57,1,3),(49,2,1),(55,2,1),(63,2,1),(54,2,2),(56,2,2),(57,2,2),(58,2,2),(59,2,2),(60,2,2),(62,2,2),(50,2,3),(50,3,1),(54,3,1),(55,3,1),(57,3,1),(49,3,2),(56,3,2),(58,3,2),(59,3,2),(60,3,2),(62,3,2),(63,3,2),(55,4,1),(56,4,1),(57,4,1),(62,4,1),(50,4,2),(54,4,2),(58,4,2),(59,4,2),(60,4,2),(49,4,3),(63,4,3),(49,17,1),(55,17,1),(60,17,1),(54,17,2),(56,17,2),(57,17,2),(58,17,2),(59,17,2),(62,17,2),(50,17,3),(63,17,3),(55,18,1),(56,18,1),(57,18,1),(58,18,1),(63,18,1),(49,18,2),(50,18,2),(54,18,2),(59,18,2),(60,18,2),(62,18,2);
...
--
-- Dumping routines for database 'tp_software'
--
/*!50003 DROP PROCEDURE IF EXISTS `definir_valores_actuales` */;
...
DELIMITER ;;
CREATE DEFINER=`sistema`@`localhost` PROCEDURE `definir_valores_actuales`()
BEGIN
DROP VIEW IF EXISTS maximas_fechas;
CREATE VIEW maximas_fechas AS
SELECT idCaracteristica, idOpcion, MAX(fecha_desde) maxFecha
FROM valores
GROUP BY idCaracteristica, idOpcion;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `tt_for_ranking` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-02-17 14:45:48
