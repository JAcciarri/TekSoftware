			...
			<nav class="navbar top-navbar navbar-expand-md navbar-light">
				<div class="navbar-header" data-logobg="skin5">
					...
					<div class="navbar-brand">
						<a href="indexAdmin.jsp" class="logo"> <!-- Logo icon --> <b
			...
			<div class="page-breadcrumb">
				<div class="row">
					...
					<div class="col-5 align-self-left">
						<a class="addbutton" href="addCaracteristica.jsp">+ Añadir
							Caracteristica</a>
					</div>
				</div>
			</div>
                    ...
                    %>
							<tr>
								...
								<td><a class="editbutton"
									href="EditCaracteristicaServlet?id=<%=c.getIdCaracteristica()%> ">
										Editar </a> <a class="deletebutton"
									href="DeleteCaracteristicaServlet?id=<%=c.getIdCaracteristica()%>">
										Eliminar </a></td>
							</tr>
							<%} %>
						</tbody>
