    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5">
          ...
          <p>Somos una compañía que desarrolla soluciones
			de software innovadoras para audiencias globales,
			basándonos en las tecnologías y tendencias emergentes. Combinamos el rigor de la ingeniería y la
			tecnología de los proveedores TI con la mirada creativa y cultural de las agencias digitales. TekSoftware es
			el lugar donde la ingeniería, el diseño y la innovación
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-3">
          ...
          <p>Ayudamos a nuestros clientes a superar los retos más complejos a través de nuestros servicios líderes en estrategia,
           consultoría, digital, tecnología y operaciones.
           Con experiencia en más de cuarenta sectores y en todas las áreas de negocio de la empresa,
           ofrecemos resultados en transformación para el exigente nuevo mundo digital.</p>
          ...
          <div class="row mt-5">
            ...
            <div class="col-lg-6 col-md-6 mb-4">
              <div class="service">
                ...
                <h3>Web Design</h3>
                <p>Interfaz amigable con el usuario. Diseño ágil e intuitivo.</p>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 mb-4">
              <div class="service">
                ...
                <h3>App Design</h3>
                <p>Diseños a medida. Funcionalidad y estetica en todos los dispositivos.</p>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 mb-4">
              <div class="service">
                ...
                <h3>Despegue</h3>
                <p>Utilización de las técnicas de marketing más recientes para lograr un mejor posicionamiento.</p>
              </div>
            </div>
          </div>
        </div>
